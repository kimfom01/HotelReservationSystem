...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Admin.Domain.Entities.Admin.Hotel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Admin.Domain.Entities.Admin.Room", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Admin.Domain.Entities.Admin.RoomType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Admin.Domain.Entities.Admin.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Admin.Domain.Entities.Common.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Admin.Domain.Entities.Common.UserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Admin.Domain.Entities.Admin.Room", b =>
                {
                    b.HasOne("Admin.Domain.Entities.Admin.Hotel", "Hotel")
                        .WithMany("Rooms")
                        .HasForeignKey("HotelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Admin.Domain.Entities.Admin.RoomType", "RoomType")
                        .WithMany("Rooms")
            ...
            modelBuilder.Entity("Admin.Domain.Entities.Admin.User", b =>
                {
                    b.HasOne("Admin.Domain.Entities.Admin.Hotel", null)
                        .WithMany("Users")
                        .HasForeignKey("HotelId");
                });
            ...
            modelBuilder.Entity("Admin.Domain.Entities.Common.Role", b =>
                {
                    b.HasOne("Admin.Domain.Entities.Admin.User", null)
                        .WithMany("Roles")
            ...
            modelBuilder.Entity("Admin.Domain.Entities.Common.UserRole", b =>
                {
                    b.HasOne("Admin.Domain.Entities.Common.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Admin.Domain.Entities.Admin.User", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
